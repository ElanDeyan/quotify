...
import 'package:backup_repository/src/models/backup.dart';
import 'package:backup_repository/src/models/backup_model_errors.dart';
...
void main() {
  ...
  group('toMap', () {
    ...
    group('string values', () {
      test('themeBrightness value should be a valid member name', () {
        for (final themeBrightness in ThemeBrightness.values) {
          final sample = _backupWithDefaultData()
              .copyWith(themeBrightness: themeBrightness);
      ...
      test('primaryColor value should be a valid member name', () {
        for (final primaryColor in PrimaryColors.values) {
          final sample =
              _backupWithDefaultData().copyWith(primaryColor: primaryColor);
    ...
    group('map values', () {
      test('privacyData should be valid', () {
        ...
        final sampleBackup =
            _backupWithDefaultData().copyWith(privacyData: samplePrivacyData);
    ...
    group('list of maps', () {
      ...
      group('quotes', () {
        test('should be valid list of maps', () {
          ...
          final sampleBackup =
              _backupWithDefaultData().copyWith(quotes: quotes);
  ...
  group('fromMap', () {
    ...
    group('if missing any key', () {
      test(
          'like ${ThemeBrightness.jsonKey}, should return failure with'
        ...
        expect(
          fromMap,
          isA<Failure<Backup, BackupModelErrors>>(),
        );
        expect(
      ...
      test(
          'like ${PrimaryColors.jsonKey}, should return failure with'
          ' ${BackupModelErrors.invalidMapRepresentation}', () {
        final sampleBackupMapWithoutId = _backupWithDefaultData().toMap()
      ...
      test(
          'like ${Languages.jsonKey}, should return failure with'
          ' ${BackupModelErrors.invalidMapRepresentation}', () {
        final sampleBackupMapWithoutId = _backupWithDefaultData().toMap()
      ...
      test(
          'like ${PrivacyData.jsonKey}, should return failure with'
          ' ${BackupModelErrors.invalidMapRepresentation}', () {
        final sampleBackupMapWithoutId = _backupWithDefaultData().toMap()
      ...
      test(
          'like ${Tag.listOfTagsJsonKey}, should return failure with'
          ' ${BackupModelErrors.invalidMapRepresentation}', () {
        final sampleBackupMapWithoutId = _backupWithDefaultData().toMap()
      ...
      test(
          'like ${Quote.listOfQuotesJsonKey}, should return failure with'
          ' ${BackupModelErrors.invalidMapRepresentation}', () {
        final sampleBackupMapWithoutId = _backupWithDefaultData().toMap()
    ...
    group('if some value is invalid', () {
      test(
        'like themeBrightness should return Failure '
      ...
      test(
        'like primaryColors should return Failure '
      ...
      test(
        'like language should return Failure '
      ...
      test(
        'like privacyData should return Failure '
        ...
        () {
          ...
          final wrongMapSamples = <Map<String, Object?>>[
            privacyData.toMap()
              ..remove(PrivacyRepository.allowErrorReportingKey),
      ...
      test(
        'like tags should return Failure '
      ...
      test(
        'like quotes should return Failure '
...
List<Map<String, Object?>> _wrongTagsMapList() {
  final negativeId = _sampleTag().toMap()
    ..update(
      'id',
      (_) => -5,
    );

  final emptyLabel = _sampleTag().toMap()
    ..update(
      'label',
      (_) => '',
    );

  final blankLabel = _sampleTag().toMap()
    ..update(
      'label',
      (_) => '    ',
    );
...
List<Map<String, Object?>> _wrongQuotesMapSample() {
  ...
  final withNegativeId = _sampleQuote().toMap()
    ..update(
      'id',
      (_) => faker.randomGenerator.integer(-1, min: -20),
    );
  final withoutContent = _sampleQuote().toMap()..remove('content');
  final withEmptyContent = _sampleQuote().toMap()
    ..update(
      'content',
      (_) => '',
    );
  ...
  final withEmptyAuthor = _sampleQuote().toMap()
    ..update(
      'author',
      (_) => '',
    );
  ...
  final withEmptySource = _sampleQuote().toMap()
    ..update(
      'source',
      (_) => '',
    );
